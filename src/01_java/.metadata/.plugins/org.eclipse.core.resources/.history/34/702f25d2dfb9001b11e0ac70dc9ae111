...
public class LibMain {
	public static void main(String[] args) {
		...
		BookLib[] books = {new BookLib("001", "자바", "자길동"),
						new BookLib("002", "오라클", "오길동"),
						new BookLib("003", "파이썬", "파길동"),
						new BookLib("004", "웹", "웹길동"),
						new BookLib("005", "하둡", "하길동")
		};
		...
		do {
			...
			case 1: // 1 책이름 입력 > 2 책조회 > 3 책상태 확인 > 4 대출인, 대출일 > 5 대출
				...
				}else if(books[idx].getState() == ILendable.STATE_BORROWED) { // 도서가 idx 번째에 있을때
